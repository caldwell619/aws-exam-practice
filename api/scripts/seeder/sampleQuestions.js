module.exports = [
	{
		...
		'incorrectAnswers': [
			...
			'Store the database credentials in environment variables on the EC2 instances. \
			Rotate the credentials by relaunching the EC2 instances'
		],
		'correctAnswer': 'Store the database credentials in AWS Secrets Manager. \
		Configure Secrets Manager to automatically \
